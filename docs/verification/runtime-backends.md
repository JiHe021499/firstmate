...
ok - real herdr 0.8.2-preview.2026-09-06-9e9bc8a14466: a gone session reads recoverable while a live pane and a malformed target do not
...
ok - real herdr: interrupt preserves the endpoint and every control path preserves the local copy
